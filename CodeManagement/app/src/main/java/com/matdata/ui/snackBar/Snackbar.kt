...
class Snackbar private constructor(context: Context) : SnackbarLayout(context) {
    ...
    fun duration(duration: Long): Snackbar {
        mCustomDuration = if (duration > 0) duration else mCustomDuration
        return this
    }
    ...
    private fun init(context: Context, targetActivity: Activity?, parent: ViewGroup, usePhoneLayout: Boolean): ViewGroup.MarginLayoutParams {
        ...
        val res = resources
        color = if (color != mUndefinedColor) color else res.getColor(R.color.colorPrimaryDark)
    ...
    companion object {
        ...
        fun getInAnimationResource(snackbarPosition: SnackbarPosition): Int {
            return if (snackbarPosition == SnackbarPosition.TOP) R.anim.sb__top_in else R.anim.sb__bottom_in
        }
        ...
        fun getOutAnimationResource(snackbarPosition: SnackbarPosition): Int {
            return if (snackbarPosition == SnackbarPosition.TOP) R.anim.sb__top_out else R.anim.sb__bottom_out
        }
