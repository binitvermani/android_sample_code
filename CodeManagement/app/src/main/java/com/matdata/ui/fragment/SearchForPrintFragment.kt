...
class SearchForPrintFragment : BaseFragment(), ClickHandler {

    private var binding: FragmentSearchForPrintBinding? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if(binding == null) {
            binding = FragmentSearchForPrintBinding.inflate(inflater, container, false)
        }
        return binding!!.root
    }
